...
public class KlingWord {
  ...
  // KlingonDictionary.KlingWord's private data members
  ...
  // KlingonDictionary.KlingWord overrides toString() to print a meaningful message
  public String toString(){
    String rs = "KlingonDictionary.KlingWord: " + kn + ", English meaning: " + en;
    return rs;
  }
